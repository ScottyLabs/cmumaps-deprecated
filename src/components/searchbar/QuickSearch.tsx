...
export default function QuickSearch({
  ...
  const renderHelper = (
    ...
    return (
      ...
      >
        ...
        >
          <Image alt={name + ' icon'} src={icon} className="h-9 w-9"></Image>
        </div>
  ...
  return (
    <CollapsibleSearch title="Quick Search">
      <div className="w-var(--search-width-desktop) mx-3 mb-3 grid grid-cols-4 gap-2 rounded-xl border border-[#dddddd] bg-white p-2">
